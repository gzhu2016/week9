window.onload = function () {
    ...
    drawStar(context, 320, 64, canvas.height / 45, canvas.height / 20, Math.atan(5 / 3) / Math.PI + 188);//first
    drawStar(context, 384, 128, canvas.height / 45, canvas.height / 20, Math.atan(7 / 1) / Math.PI + 175);//second
    drawStar(context, 384, 224, canvas.height / 45, canvas.height / 20, (360 - Math.atan(7 / 2) / Math.PI));//third
    drawStar(context, 320, 288, canvas.height / 45, canvas.height / 20, (335 - Math.atan(5 / 4) / Math.PI));//fourth
    /**context.beginPath();
